  ...
  return (
    ...
    >
        <div className="h-full flex items-center justify-center p-1 md:p-2 relative overflow-hidden">
          ...
          >
            <div className="px-2 md:px-4 pt-8 md:pt-12 pb-20 md:pb-32 text-center space-y-0.5 md:space-y-1.5 max-h-full w-full flex flex-col items-center">
              <motion.div
                initial={{ opacity: 0, y: -20 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.8, ease: "easeOut", delay: 0.5 }}
              >
                <h1 className="font-gujarati text-base md:text-3xl font-bold text-white drop-shadow-lg">
                  ॥ ૐ બ્રહ્માણીયૈ નમઃ ॥
                </h1>
              </motion.div>
              ...
              >
                <span className="text-yellow-300 text-xs md:text-lg">卐</span>
                <h2 className="font-gujarati text-xs md:text-lg font-semibold text-yellow-200">
                  મંગલ અવસરો
                </h2>
                <span className="text-yellow-300 text-xs md:text-lg">卐</span>
              </motion.div>
              ...
              <div className="grid grid-cols-2 gap-1 md:gap-2 pt-0.5 max-w-xs md:max-w-sm w-full items-stretch">
                ...
                >
                  <div className="min-h-[1.5rem] md:min-h-[2.75rem] flex items-center justify-center">
                    <h4 className="font-gujarati text-xs md:text-base font-semibold text-white text-center">
                      મંડપ મુહૂર્ત
                    </h4>
                  </div>
                  <div className="border-t border-b border-yellow-300 py-0.25 w-full flex justify-center">
                    <span className="text-sm md:text-base">✦</span>
                  </div>
                  <div className="min-h-[2.25rem] md:min-h-[2.5rem] flex flex-col justify-center">
                    <p className="font-gujarati text-xs md:text-sm text-white text-center">
                      ૨૦/૦૨/૨૦૨૬, શુક્રવાર
                    </p>
                    <p className="font-gujarati text-xs md:text-sm text-white text-center">
                      સવારે ૮:૦૦ કલાકે
                ...
                >
                  ...
                  <div className="min-h-[1.75rem] md:min-h-[2.5rem] flex flex-col justify-center">
                    <p className="font-gujarati text-[0.65rem] md:text-sm text-white text-center">
                      ૨૦/૦૨/૨૦૨૬, શુક્રવાર
                    </p>
                    <p className="font-gujarati text-[0.65rem] md:text-sm text-white text-center">
                      સવારે ૧૧:૦૦ કલાકે
              ...
              >
                ...
                <div className="border-t border-b border-yellow-300 py-0.25 max-w-xs w-full flex justify-center">
                  <span className="text-xs md:text-base">✦</span>
                </div>
                <p className="font-gujarati text-[0.65rem] md:text-sm text-white text-center">
                  ૨૦/૦૨/૨૦૨૬, શુક્રવાર
